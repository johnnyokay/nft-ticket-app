...
export default function Card(props: any) {
  ...
  const purchaseNFT = async (tokenId: number) => {
    ...
    try {
      ...
      const verifyTxn = await contract.purchaseNFT(props.walletAddress, tokenId, {value: 1})
  ...
  return (
    ...
    <Box maxW='sm' shadow="md" borderWidth='1px' borderRadius='lg' overflow='hidden'>
      <Image src={"https://ipfs.io/ipfs/QmPtUx44pEg6KtorBrcjNxJYwx7S1nY7NPoCpmLUXxcBts"} alt={props.tokenId} />
      ...
      <Box p='4'>
        ...
        <Box display='flex' mt='2' alignItems="self-end">
          <Button onClick={() => purchaseNFT(props.tokenId)}>Purchase Ticket</Button>
        </Box>
      </Box>
    </Box>
    </>
